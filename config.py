...
VAL_CAT_NAMES = {
    ...
    # Ḍād-v2 — catégories prose ajoutées
    3: "تفسير", 7: "شروح", 24: "سيرة", 25: "تاريخ", 26: "تراجم",
}

# Ḍād-v2 — mix effectif pour la ValW pondérée (parts du corpus v2 élargi).
# عروض (cat 33) sans val → absent ; weighted_val_loss renormalise sur les présents.
VAL_EVAL_MIX_V2 = {
    31: 0.198,   # نحو/صرف
    25: 0.132,   # تاريخ
    30: 0.123,   # معاجم
